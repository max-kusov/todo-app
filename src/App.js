...
import { List, AddList, Tasks } from './components/imports'
  ...
  return (
    <div className="todo">
      ...
      <div className="tasks-wrapper">
        <Routes>
          <Route path='/' element={lists && lists.map(list => <Tasks key={list.id} onAddTask={onAddTask} list={list} onEditTitle={onEditListTitle} withOutEmpty />)} />
          <Route path='/lists/:id' element={lists && activeItem && <Tasks onAddTask={onAddTask} list={activeItem} onEditTitle={onEditListTitle} />} />
